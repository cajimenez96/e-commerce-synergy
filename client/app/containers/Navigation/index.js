            ...
            <div className='brand'>
              {categories && categories.length > 0 && (
                <Button
                  ...
                  ariaLabel={t('open_menu')}
                  icon={<BarsIcon />}
                  onClick={toggleMenuHandler}
                />
              )}
              <Link to='/'>
                <h1 className='logo'>{t('mern_store')}</h1>
              </Link>
            </div>
          </Col>  
          <Col  
                ...
                {authenticated ? (
                  <UncontrolledDropdown nav inNavbar>
                    ...
                    <DropdownMenu right>
                      ...
                      <DropdownItem onClick={signOut}>{t('sign_out')}</DropdownItem>
                    </DropdownMenu>
                  </UncontrolledDropdown>
                ) : (
                  <UncontrolledDropdown nav inNavbar>
